...
public class GafanhotoDAO {
    ...
    protected void salvarG(Gafanhoto g) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(slq)) {
            ...
            throw new RuntimeException(e + "erro na linha 29");
        }
    }
    ...
    protected int contarG() {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            throw new RuntimeException(e + "erro na linha 44");
        }
        return totalGDB;
    }
    ...
    protected Gafanhoto pegarG(int idGafan) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            throw new RuntimeException(e + "erro na linha 72");
        }
        return gafanhotos;
    }
    ...
    protected void atualizarG(Gafanhoto g, int idG) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            throw new RuntimeException(e + "erro na linha 86");
        }
    }

    protected void deletarGafan(int idGafan) {
        String sql = "DELETE FROM gafanhoto WHERE id = ?";

        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setInt(1, idGafan);
            stmt.executeUpdate();
        } catch (SQLException e) {
            throw new RuntimeException(e + "erro na linha 97");
        }
    }
}
